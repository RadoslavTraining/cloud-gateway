...
public class StudentGatewayService {
    ...
    public List<Student> findAllStudents() {
        return Arrays.asList(Objects.requireNonNull(restTemplate.getForObject(studentServiceUrl, Student[].class)));
    }

    public Student saveStudent(Student student) {
        return restTemplate.postForObject(studentServiceUrl,student,Student.class);
    }


    public Student findStudentById(Long studentId) {
        return restTemplate.getForObject(String.format("%s/%d", studentServiceUrl,studentId), Student.class);
